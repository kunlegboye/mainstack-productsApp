...
const authSevice = __importStar(require("../services/authService"));
function signup(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { name, email, phone_number, password } = req.body;
            const result = yield authSevice.signup({ name, email, phone_number, password });
...
function signin(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const result = yield authSevice.login({ email, password });
...
function logout(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield authSevice.logout({ user, token });
